                ...
                <div className="flex items-center gap-6">
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-2">
                      ...
                      <span className={`text-2xl font-bold ${getScoreColor(mockAnalysis.overallScore)}`}>
                        {mockAnalysis.overallScore}%
                      </span>
                    </div>
                    <Progress value={mockAnalysis.overallScore} className="h-3" />
                    <p className="text-sm text-muted-foreground mt-2">
                      {mockAnalysis.overallScore >= 80 ? "Excellent match" : 
                       mockAnalysis.overallScore >= 60 ? "Good match" : "Needs improvement"}
                    </p>
                  </div>
                </div>
              </CardContent>
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <div>
                      <p className="text-2xl font-bold">
                        {mockAnalysis.skillMatches.filter(s => s.match && s.required).length}
                      </p>
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-4">
                  {mockAnalysis.skillMatches.map((skill, index) => (
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Required: {mockAnalysis.experience.required}</p>
                      <p className="text-sm text-muted-foreground">Candidate: {mockAnalysis.experience.candidate}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
                ...
                <CardContent className="space-y-4">
                  <div className="flex items-start gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-sm text-muted-foreground">Required: {mockAnalysis.education.required}</p>
                      <p className="text-sm text-muted-foreground">Candidate: {mockAnalysis.education.candidate}</p>
                    </div>
                  </div>
                </CardContent>
              </Card>
